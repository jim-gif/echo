  ...
  <div id='detail'
    ...
    <div class="detail-container">
      ...
      <div class="detail-user">
        <div class="user-left">
          <div class="user-img-container">
            <img class="user-img"
                 :src="audio.data.sound.user.avatar_50">
            <img v-if="audio.data.sound.user.famous_type"
                 class='user-vip'
      ...
      <div class="detail-cover">
        <img class="cover-img"
             :src="audio.data.sound.pic_500">
        <div class="cover-danmu"
      ...
      <div class="detail-lyric">
        ...
        <!-- 歌词 -->
        <div v-if="audio.data.sound.lyrics"
             v-html="audio.data.sound.lyrics"></div>
        <!-- 没有歌词 -->
        <div v-if="!audio.data.sound.song_info && !audio.data.sound.lyrics"
             class="noLyric">没有相关的歌词T T~ </div>
      </div>
      <!-- 更多推荐 -->
...
export default {
  ...
  methods: {
    ...mapMutations(['SET_AUDIO_DATA', 'SET_AUDIO_PLAY']),
    getMusicData() {
      this.$indicator.open()
      this.loading = true
